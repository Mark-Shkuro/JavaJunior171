        ...
        for (int i = 0; i < minnoePole.length; i++) {
            for (int j = 0; j < minnoePole[i].length; j++) {
                if (minnoePole[i][j] == -1) {
                    if (i == 0 && j == 0) { // угол верхний левый
                    ...
                    } else if (i == minnoePole.length - 1 && j == 0) { // нижний левый угол
                        if (minnoePole[0][j - 1] != -1) {
                            minnoePole[0][j - 1] = minnoePole[0][j - 1] + 1;
                        }
                        if (minnoePole[i + 1][j - 1] != -1) {
                        ...
                        if (minnoePole[i + 1][0] != -1) {
                            minnoePole[i + 1][0] = minnoePole[i + 1][0] + 1;
                        }
                    } else if (i == minnoePole.length - 1 && j == minnoePole[i].length - 1) { // нижний правый угол
                        if (minnoePole[0][j - 1] != -1) {
                            minnoePole[0][j - 1] = minnoePole[0][j - 1] + 1;
                        }
                        if (minnoePole[i + 1][j - 1] != -1) {
                        ...
                        if (minnoePole[i][j + 1] != -1) {
                            minnoePole[i][j + 1] = minnoePole[i][j + 1] + 1;
                        }
                        if (minnoePole[i][j - 1] != -1) {
                            minnoePole[i][j - 1] = minnoePole[i][j - 1] + 1;
                        }
                    } else if (i == minnoePole.length - 1) { // нижний ряд
                        if (minnoePole[i - 1][j - 1] != -1) {
                            minnoePole[i - 1][j - 1] = minnoePole[i - 1][j - 1] + 1;
                        }
                        if (minnoePole[i - 1][j] != -1) {
                    ...
                    } else if (j == minnoePole[i].length - 1) { // правый ряд
                        if (minnoePole[i + 1][j - 1] != -1) {
                            minnoePole[i + 1][j - 1] = minnoePole[i + 1][j - 1] + 1;
                        }
                        if (minnoePole[i - 1][j - 1] != -1) {
